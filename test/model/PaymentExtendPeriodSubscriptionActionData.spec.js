...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentExtendPeriodSubscriptionActionData();
  });
  ...
  describe('PaymentExtendPeriodSubscriptionActionData', function() {
    it('should create an instance of PaymentExtendPeriodSubscriptionActionData', function() {
      // uncomment below and update the code to test PaymentExtendPeriodSubscriptionActionData
