...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationERC20TokenPermissionParams();
  });
  ...
  describe('TokenizationERC20TokenPermissionParams', function() {
    it('should create an instance of TokenizationERC20TokenPermissionParams', function() {
      // uncomment below and update the code to test TokenizationERC20TokenPermissionParams
      //var instance = new CoboWaas2.TokenizationERC20TokenPermissionParams();
      //expect(instance).to.be.a(CoboWaas2.TokenizationERC20TokenPermissionParams);
    });
