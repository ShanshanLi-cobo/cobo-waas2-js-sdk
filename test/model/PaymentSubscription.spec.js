...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentSubscription();
  });
  ...
  describe('PaymentSubscription', function() {
    it('should create an instance of PaymentSubscription', function() {
      // uncomment below and update the code to test PaymentSubscription
      //var instance = new CoboWaas2.PaymentSubscription();
      //expect(instance).to.be.a(CoboWaas2.PaymentSubscription);
    });
