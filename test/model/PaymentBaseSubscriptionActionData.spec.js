...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentBaseSubscriptionActionData();
  });
  ...
  describe('PaymentBaseSubscriptionActionData', function() {
    it('should create an instance of PaymentBaseSubscriptionActionData', function() {
      // uncomment below and update the code to test PaymentBaseSubscriptionActionData
      //var instance = new CoboWaas2.PaymentBaseSubscriptionActionData();
      //expect(instance).to.be.a(CoboWaas2.PaymentBaseSubscriptionActionData);
    });
