...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentSubscriptionUpdateEventData();
  });
  ...
  describe('PaymentSubscriptionUpdateEventData', function() {
    it('should create an instance of PaymentSubscriptionUpdateEventData', function() {
      // uncomment below and update the code to test PaymentSubscriptionUpdateEventData
      //var instance = new CoboWaas2.PaymentSubscriptionUpdateEventData();
      //expect(instance).to.be.a(CoboWaas2.PaymentSubscriptionUpdateEventData);
    });
