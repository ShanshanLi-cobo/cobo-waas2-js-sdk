...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentUpdateTokenIdSubscriptionActionData();
  });
  ...
  describe('PaymentUpdateTokenIdSubscriptionActionData', function() {
    it('should create an instance of PaymentUpdateTokenIdSubscriptionActionData', function() {
      // uncomment below and update the code to test PaymentUpdateTokenIdSubscriptionActionData
      //var instance = new CoboWaas2.PaymentUpdateTokenIdSubscriptionActionData();
      //expect(instance).to.be.a(CoboWaas2.PaymentUpdateTokenIdSubscriptionActionData);
    });
