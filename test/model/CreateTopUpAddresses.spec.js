...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateTopUpAddresses();
  });
  ...
  describe('CreateTopUpAddresses', function() {
    it('should create an instance of CreateTopUpAddresses', function() {
      // uncomment below and update the code to test CreateTopUpAddresses
      //var instance = new CoboWaas2.CreateTopUpAddresses();
      //expect(instance).to.be.a(CoboWaas2.CreateTopUpAddresses);
    });
    ...
    it('should have the property custom_payer_ids (base name: "custom_payer_ids")', function() {
      // uncomment below and update the code to test the property custom_payer_ids
      //var instance = new CoboWaas2.CreateTopUpAddresses();
      //expect(instance).to.be();
    });
