...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.KytScreeningsEventData();
  });
  ...
  describe('KytScreeningsEventData', function() {
    it('should create an instance of KytScreeningsEventData', function() {
      // uncomment below and update the code to test KytScreeningsEventData
      //var instance = new CoboWaas2.KytScreeningsEventData();
      //expect(instance).to.be.a(CoboWaas2.KytScreeningsEventData);
    });
