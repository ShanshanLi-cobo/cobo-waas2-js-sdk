...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PayoutEstimatedFee();
  });
  ...
  describe('PayoutEstimatedFee', function() {
    it('should create an instance of PayoutEstimatedFee', function() {
      // uncomment below and update the code to test PayoutEstimatedFee
      //var instance = new CoboWaas2.PayoutEstimatedFee();
      //expect(instance).to.be.a(CoboWaas2.PayoutEstimatedFee);
    });
