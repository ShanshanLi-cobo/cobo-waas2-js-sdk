...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateWebhookEventInfo();
  });
  ...
  describe('CreateWebhookEventInfo', function() {
    it('should create an instance of CreateWebhookEventInfo', function() {
      // uncomment below and update the code to test CreateWebhookEventInfo
      //var instance = new CoboWaas2.CreateWebhookEventInfo();
      //expect(instance).to.be.a(CoboWaas2.CreateWebhookEventInfo);
    });
