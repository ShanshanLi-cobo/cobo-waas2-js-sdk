...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentSubscriptionActionDetail();
  });
  ...
  describe('PaymentSubscriptionActionDetail', function() {
    it('should create an instance of PaymentSubscriptionActionDetail', function() {
      // uncomment below and update the code to test PaymentSubscriptionActionDetail
      //var instance = new CoboWaas2.PaymentSubscriptionActionDetail();
      //expect(instance).to.be.a(CoboWaas2.PaymentSubscriptionActionDetail);
    });
