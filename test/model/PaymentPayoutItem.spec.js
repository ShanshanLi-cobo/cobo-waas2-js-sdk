...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentPayoutItem();
  });
  ...
  describe('PaymentPayoutItem', function() {
    it('should create an instance of PaymentPayoutItem', function() {
      // uncomment below and update the code to test PaymentPayoutItem
      //var instance = new CoboWaas2.PaymentPayoutItem();
      //expect(instance).to.be.a(CoboWaas2.PaymentPayoutItem);
    });
