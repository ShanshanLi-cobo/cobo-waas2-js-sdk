...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateWebhookEventParams();
  });
  ...
  describe('CreateWebhookEventParams', function() {
    it('should create an instance of CreateWebhookEventParams', function() {
      // uncomment below and update the code to test CreateWebhookEventParams
      //var instance = new CoboWaas2.CreateWebhookEventParams();
      //expect(instance).to.be.a(CoboWaas2.CreateWebhookEventParams);
    });

    it('should have the property channel_id (base name: "channel_id")', function() {
      // uncomment below and update the code to test the property channel_id
      //var instance = new CoboWaas2.CreateWebhookEventParams();
    ...
    it('should have the property wallet_scopes_info (base name: "wallet_scopes_info")', function() {
      // uncomment below and update the code to test the property wallet_scopes_info
      //var instance = new CoboWaas2.CreateWebhookEventParams();
      //expect(instance).to.be();
    });
