...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentEstimateFee();
  });
  ...
  describe('PaymentEstimateFee', function() {
    it('should create an instance of PaymentEstimateFee', function() {
      // uncomment below and update the code to test PaymentEstimateFee
      //var instance = new CoboWaas2.PaymentEstimateFee();
      //expect(instance).to.be.a(CoboWaas2.PaymentEstimateFee);
    });
