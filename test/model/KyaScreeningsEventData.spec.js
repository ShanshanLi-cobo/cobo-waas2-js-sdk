...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.KyaScreeningsEventData();
  });
  ...
  describe('KyaScreeningsEventData', function() {
    it('should create an instance of KyaScreeningsEventData', function() {
      // uncomment below and update the code to test KyaScreeningsEventData
      //var instance = new CoboWaas2.KyaScreeningsEventData();
      //expect(instance).to.be.a(CoboWaas2.KyaScreeningsEventData);
    });
