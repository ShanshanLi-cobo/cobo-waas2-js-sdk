...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentUpdateAmountSubscriptionActionData();
  });
  ...
  describe('PaymentUpdateAmountSubscriptionActionData', function() {
    it('should create an instance of PaymentUpdateAmountSubscriptionActionData', function() {
      // uncomment below and update the code to test PaymentUpdateAmountSubscriptionActionData
