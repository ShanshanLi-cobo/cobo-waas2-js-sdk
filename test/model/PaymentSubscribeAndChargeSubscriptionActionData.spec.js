...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentSubscribeAndChargeSubscriptionActionData();
  });
  ...
  describe('PaymentSubscribeAndChargeSubscriptionActionData', function() {
    it('should create an instance of PaymentSubscribeAndChargeSubscriptionActionData', function() {
      // uncomment below and update the code to test PaymentSubscribeAndChargeSubscriptionActionData
      //var instance = new CoboWaas2.PaymentSubscribeAndChargeSubscriptionActionData();
      //expect(instance).to.be.a(CoboWaas2.PaymentSubscribeAndChargeSubscriptionActionData);
    });
