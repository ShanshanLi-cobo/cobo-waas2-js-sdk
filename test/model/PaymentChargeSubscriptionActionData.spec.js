...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentChargeSubscriptionActionData();
  });
  ...
  describe('PaymentChargeSubscriptionActionData', function() {
    it('should create an instance of PaymentChargeSubscriptionActionData', function() {
      // uncomment below and update the code to test PaymentChargeSubscriptionActionData
      //var instance = new CoboWaas2.PaymentChargeSubscriptionActionData();
      //expect(instance).to.be.a(CoboWaas2.PaymentChargeSubscriptionActionData);
    });
