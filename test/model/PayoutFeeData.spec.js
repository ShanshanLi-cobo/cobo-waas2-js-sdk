...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PayoutFeeData();
  });
  ...
  describe('PayoutFeeData', function() {
    it('should create an instance of PayoutFeeData', function() {
      // uncomment below and update the code to test PayoutFeeData
      //var instance = new CoboWaas2.PayoutFeeData();
      //expect(instance).to.be.a(CoboWaas2.PayoutFeeData);
    });
