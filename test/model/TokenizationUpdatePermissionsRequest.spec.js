...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationUpdatePermissionsRequest();
  });
  ...
  describe('TokenizationUpdatePermissionsRequest', function() {
    it('should create an instance of TokenizationUpdatePermissionsRequest', function() {
      // uncomment below and update the code to test TokenizationUpdatePermissionsRequest
      //var instance = new CoboWaas2.TokenizationUpdatePermissionsRequest();
      //expect(instance).to.be.a(CoboWaas2.TokenizationUpdatePermissionsRequest);
    });
