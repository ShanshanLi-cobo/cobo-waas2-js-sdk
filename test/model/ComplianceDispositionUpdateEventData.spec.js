...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.ComplianceDispositionUpdateEventData();
  });
  ...
  describe('ComplianceDispositionUpdateEventData', function() {
    it('should create an instance of ComplianceDispositionUpdateEventData', function() {
      // uncomment below and update the code to test ComplianceDispositionUpdateEventData
      //var instance = new CoboWaas2.ComplianceDispositionUpdateEventData();
      //expect(instance).to.be.a(CoboWaas2.ComplianceDispositionUpdateEventData);
    });
