...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.ComplianceKytScreeningsUpdateEventData();
  });
  ...
  describe('ComplianceKytScreeningsUpdateEventData', function() {
    it('should create an instance of ComplianceKytScreeningsUpdateEventData', function() {
      // uncomment below and update the code to test ComplianceKytScreeningsUpdateEventData
      //var instance = new CoboWaas2.ComplianceKytScreeningsUpdateEventData();
      //expect(instance).to.be.a(CoboWaas2.ComplianceKytScreeningsUpdateEventData);
    });
