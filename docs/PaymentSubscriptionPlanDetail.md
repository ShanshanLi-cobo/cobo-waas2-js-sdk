# CoboWaas2.PaymentSubscriptionPlanDetail
...
**charge_amount** | **String** | The subscription plan crypto amount with input token_id.  | [optional] 
**contract_address** | **String** | The subscription contract address in cobo. | [optional] 
