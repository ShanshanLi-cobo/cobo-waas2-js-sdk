...
class PaymentPayoutItem {
    ...
    constructor(payout_item_id, payout_id, amount, status) { 
        ...
        PaymentPayoutItem.initialize(this, payout_item_id, payout_id, amount, status);
    }
...
PaymentPayoutItem.RequiredProperties = ["payout_item_id", "payout_id", "amount", "status"];
 ...
 */
PaymentPayoutItem.prototype['merchant_id'] = undefined;
