...
/**
 * The PaymentSubscriptionPlan model module.
 * @module model/PaymentSubscriptionPlan
 */
class PaymentSubscriptionPlan {
    /**
     * Constructs a new <code>PaymentSubscriptionPlan</code>.
     * @alias module:model/PaymentSubscriptionPlan
    ...
    /**
     * Constructs a <code>PaymentSubscriptionPlan</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentSubscriptionPlan} obj Optional instance to populate.
     * @return {module:model/PaymentSubscriptionPlan} The populated <code>PaymentSubscriptionPlan</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentSubscriptionPlan();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentSubscriptionPlan</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentSubscriptionPlan</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentSubscriptionPlan.RequiredProperties) {
...
PaymentSubscriptionPlan.RequiredProperties = ["plan_id", "developer_plan_id", "period_type", "periods", "interval", "amount"];
