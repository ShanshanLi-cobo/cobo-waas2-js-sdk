...
class SubmitKytScreeningsReviewBody {
     ...
     * @param transaction_id {String} The UUID of the transaction for external KYT review. This identifies the transaction that requires external compliance review.
