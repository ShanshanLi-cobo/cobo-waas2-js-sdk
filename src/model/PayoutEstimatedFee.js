...
/**
 * The PayoutEstimatedFee model module.
 * @module model/PayoutEstimatedFee
 */
class PayoutEstimatedFee {
    /**
     * Constructs a new <code>PayoutEstimatedFee</code>.
     * @alias module:model/PayoutEstimatedFee
     * @param {(module:model/EstimatedEvmEip1559Fee|module:model/EstimatedEvmLegacyFee|module:model/EstimatedFixedFee|module:model/EstimatedUtxoFee)} instance The actual instance to initialize PayoutEstimatedFee.
     */
    constructor(instance = null) {
        ...
        // if (match > 1) {
        //    throw new Error("Multiple matches found constructing `PayoutEstimatedFee` with oneOf schemas EstimatedEvmEip1559Fee, EstimatedEvmLegacyFee, EstimatedFixedFee, EstimatedUtxoFee. Input: " + JSON.stringify(instance));
        // } else
        if (match === 0) {
        //    this.actualInstance = null; // clear the actual instance in case there are multiple matches
        //    throw new Error("No match found constructing `PayoutEstimatedFee` with oneOf schemas EstimatedEvmEip1559Fee, EstimatedEvmLegacyFee, EstimatedFixedFee, EstimatedUtxoFee. Details: " +
        //                    errorMessages.join(", "));
        return;
        } else { // only 1 match
            // the input is valid
    ...
    /**
     * Constructs a <code>PayoutEstimatedFee</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayoutEstimatedFee} obj Optional instance to populate.
     * @return {module:model/PayoutEstimatedFee} The populated <code>PayoutEstimatedFee</code> instance.
     */
    static constructFromObject(data, obj) {
        return new PayoutEstimatedFee(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = PayoutEstimatedFee.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/PayoutEstimatedFee} An instance of PayoutEstimatedFee.
     */
    static fromJSON = function(json_string){
        return PayoutEstimatedFee.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
PayoutEstimatedFee.prototype['fee_type'] = undefined;

/**
 * The token ID of the transaction fee.
 * @member {String} token_id
 */
PayoutEstimatedFee.prototype['token_id'] = undefined;
 ...
 */
PayoutEstimatedFee.prototype['is_loop'] = undefined;

/**
 * The transaction fee that you need to pay for the transaction.
 * @member {String} fee_amount
 */
PayoutEstimatedFee.prototype['fee_amount'] = undefined;

/**
 * @member {module:model/EstimatedUtxoFeeSlow} slow
 */
PayoutEstimatedFee.prototype['slow'] = undefined;

/**
 * @member {module:model/EstimatedUtxoFeeSlow} recommended
 */
PayoutEstimatedFee.prototype['recommended'] = undefined;

/**
 * @member {module:model/EstimatedUtxoFeeSlow} fast
 */
PayoutEstimatedFee.prototype['fast'] = undefined;


PayoutEstimatedFee.OneOf = ["EstimatedEvmEip1559Fee", "EstimatedEvmLegacyFee", "EstimatedFixedFee", "EstimatedUtxoFee"];

export default PayoutEstimatedFee;
