...
class CreateBatchAllocationRequest {
     ...
     */
    constructor(request_id, source_type, allocation_requests) { 
        
        CreateBatchAllocationRequest.initialize(this, request_id, source_type, allocation_requests);
    }
     ...
     */
    static initialize(obj, request_id, source_type, allocation_requests) { 
...
CreateBatchAllocationRequest.RequiredProperties = ["request_id", "source_type", "allocation_requests"];
 ...
 */
CreateBatchAllocationRequest.prototype['source_type'] = undefined;
