 ...
 */
class ListCounterpartyWalletAddress200Response {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [CounterpartyWalletAddressDetail]);
            }
...
export default ListCounterpartyWalletAddress200Response;
