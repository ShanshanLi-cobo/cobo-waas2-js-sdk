...
/**
 * The PaymentSubscription model module.
 * @module model/PaymentSubscription
 */
class PaymentSubscription {
    /**
     * Constructs a new <code>PaymentSubscription</code>.
     * @alias module:model/PaymentSubscription
    ...
    /**
     * Constructs a <code>PaymentSubscription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentSubscription} obj Optional instance to populate.
     * @return {module:model/PaymentSubscription} The populated <code>PaymentSubscription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentSubscription();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentSubscription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentSubscription</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentSubscription.RequiredProperties) {
