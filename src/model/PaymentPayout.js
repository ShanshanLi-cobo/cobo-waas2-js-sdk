...
class PaymentPayout {
     ...
     */
    constructor(payout_id, request_id, payout_channel, source_type, status) { 
        
        PaymentPayout.initialize(this, payout_id, request_id, payout_channel, source_type, status);
    }
     ...
     */
    static initialize(obj, payout_id, request_id, payout_channel, source_type, status) { 
...
PaymentPayout.RequiredProperties = ["payout_id", "request_id", "payout_channel", "source_type", "status"];
 ...
 */
PaymentPayout.prototype['source_type'] = undefined;
