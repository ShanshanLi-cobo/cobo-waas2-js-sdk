 ...
 */
class ListDestinationWalletAddresses200Response {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [DestinationWalletAddressDetail]);
            }
...
export default ListDestinationWalletAddresses200Response;
