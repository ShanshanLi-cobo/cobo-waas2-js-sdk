...
class Report {
     ...
     * @param start_time {Number} The unix timestamp of the start time of the report.
     * @param end_time {Number} The unix timestamp of the end time of the report.
     * @param created_timestamp {Number} The created time of the payment report, represented as a UNIX timestamp in seconds.
     * @param report_export_format {module:model/ReportExportFormat} 
     * @param report_status {module:model/ReportStatus} 
     * @param initiator {String} The initiator of this report, usually the user's API key.
     */
