...
class TokenizationERC20WrappedTokenParams {
     ...
     * @param decimals {Number} The number of decimals for the token.
     * @param underlying_token {String} The address of the underlying token that this tokenized asset represents.
     */
    constructor(standard, name, symbol, decimals, underlying_token) { 
        
        TokenizationERC20WrappedTokenParams.initialize(this, standard, name, symbol, decimals, underlying_token);
    }
     ...
     */
    static initialize(obj, standard, name, symbol, decimals, underlying_token) { 
...
TokenizationERC20WrappedTokenParams.RequiredProperties = ["standard", "name", "symbol", "decimals", "underlying_token"];
 ...
 */
TokenizationERC20WrappedTokenParams.prototype['decimals'] = undefined;
